package com.example.zlxs.adapter;
...
import com.example.util.newAdd.GlideUtil;
import com.example.zlxs.R;
import com.example.zlxs.view.design.RoundImage;
...
public class SubjectAdapter extends RecyclerView.Adapter<SubjectAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.subject_child_view, null);
